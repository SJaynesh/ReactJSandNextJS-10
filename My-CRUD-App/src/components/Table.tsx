...
export default function Table({ allStudents, deleteStudent }: propsType) {
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 transform hover:scale-105 transition duration-300">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-gray-800">{allStudents.length}</p>
                        </div>
